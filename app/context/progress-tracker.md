...
- Prisma 7 multi-file schema: prisma.config.ts is CLI config (schema: "prisma/", migrations path, datasource URL). All .prisma files in prisma/ and subdirectories are merged. Generated client at app/generated/prisma — import from app/generated/prisma/client (no index.ts). Runtime PrismaClient always requires either adapter or accelerateUrl option.
