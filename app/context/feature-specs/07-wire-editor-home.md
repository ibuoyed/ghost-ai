...
Fetch owned and shared projects server-side using the exising project data helper and pass both lists to the sidebar.
...
Connect the hook to the sidebar dialogs.
